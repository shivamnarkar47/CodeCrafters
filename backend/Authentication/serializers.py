...
class RegisterSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['email', 'password', 'first_name', 'last_name','phone_no','profile_pic', 
                 'bank_name', 'pan_no', 'age', 'gender', 'dob', 'address']
    ...
    def create(self, validated_data):
        ...
        user = User(email=email, username=email,first_name=first_name, last_name=last_name, phone_no=phone_no,
                    bank_name=bank_name, pan_no=pan_no, age=age, dob=dob, gender=gender, address=address, profile_pic=profile_pic)
...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = [
    'username', 'full_name', 'email', 'phone_no', 'profile_pic', 

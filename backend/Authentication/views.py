    ...
    def post(self, request):
        ...
        try:
            ...
            with transaction.atomic():
                ...
                total_amount = (quantity * price_per_share) + brokerage_fee + taxes + other_charges
...
class PortfolioAPIView(APIView):
    ...
    def get(self, request):
        try:
            ...
            if created or portfolio.last_updated < timezone.now() - timezone.timedelta(days=1):
            ...
            return Response({
                ...
                "positions": [{
                    ...
                    "quantity": position.quantity,
                    "average_price": str(position.average_price),
                    "current_value": str(position.quantity * position.average_price)
